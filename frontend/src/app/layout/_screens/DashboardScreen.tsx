...
const DashboardCard = ({src, title, value, description, variant}: DashboardCardProps) => (
    <div
        ...
        className={` relative p-4 border-[1px] border-gray-800  rounded-md flex flex-col  items-start justify-evenly flex-1 text-gray-700 shadow-sm gap-2 mx-w-1/2 ${
    ...
    >
        ...
        <h1 className={`font-thin text-sm   ${variant ? "text-gray-50" : "text-gray-200"}`}>{title}</h1>
                                ...
                                .map(({amount, name, transactionDate}: any, key: Key | null | undefined) => (
                                    <div key={key} className="relative  flex bg-gray-800 border-gray-950 py-4 px-2 gap-2 rounded">
                                        ...
                                        <div className="flex flex-col w-full flex-1">
                                            ...
                                            <p className="text-xs text-white">{formatTime(transactionDate as string)}</p>
                                        </div>
                                        <p className={`text-base text-white font-bold truncate  cursor-pointer`}>
