...
const DashboardCard = ({src, title, value, description, variant}: DashboardCardProps) => (
    <div
        ...
        className={` relative p-4 dark:border-gray-950 border rounded-md flex flex-col  items-start justify-evenly flex-1 text-gray-700 shadow-sm gap-2 mx-w-1/2 ${
    ...
    return (
        <>
            ...
            <div className="z-20 flex flex-col gap-4 p-4 w-full overflow-scroll md:hidden">
                ...
                <div className=" flex-2 flex flex-col p-4 border-[1px] dark:border-gray-800 rounded-md gap-4 ">
